...
public class SimpleGraphTest {
    ...
    public void testBFS () throws VertexNotInGraphException {
        ...
        assertEquals(answer, GraphSearch.bfs(testGraph, simpleVertices.get(0)).getAllExploredVertexes());
    }
    ...
    public void testDFS() throws VertexNotInGraphException {
        ...
        Set<SimpleVertex> answer = new HashSet<>(Arrays.asList(simpleVertices.get(0), simpleVertices.get(1), simpleVertices.get(2), simpleVertices.get(3)));
        assertEquals(answer, GraphSearch.dfs(testGraph, simpleVertices.get(0)).getAllExploredVertexes());
    }
